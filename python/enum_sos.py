        ...
        for q in ipolys[(q_degree, False)]:
            ...
            for ps in itertools.product(*[ipolys[(p_degree, True)] for p_degree in p_degrees]):
                ...
                if p not in seen_p:
                    ...
                    seen_p.add(p)
                    n_qps += 1
                    if max_qps is not None and n_qps >= max_qps: break
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_qps', action='store', dest='max_qps', type=int, default=10)
    ...
    qps = list(enum_qps(ipolys=ipolys, max_degree=opts.max_degree, max_qps=opts.max_qps))
